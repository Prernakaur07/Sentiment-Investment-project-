...
from pydantic import BaseModel, HttpUrl, AnyUrl  # Changed to AnyUrl for more flexibility
...
import uvicorn
from praw import Reddit #praw for reddit API interaction 
import httpx
...
# API Configuration
NEWSAPI_KEY = "f890d45d41494ca7a465a786d74771a7"

 
GROQ_API_KEY = "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"
REDDIT_CONFIG = {
    "client_id": "U0mVHMFayecfQebCMOAIUA",
    "client_secret": "vePXM00I4HhgsRo3ZVS3HlJggTAOfg",
    "username": "Optimal_Character713",
    "password": "rahul2002",
    "user_agent": "financial-bot/0.1"
}

app = FastAPI(title="Unified Financial Headlines API")
...
@app.post("/reddit-headlines/", response_model=List[HeadlineAnalysis])
...
"Inflation", "Stock Buybacks", "Market Correction", "Bearish", "Bullish","economic growth",
"Portfolio Diversification", "Recession", "Financial Stability", "business",
"stock analysis", "GDP", "Tech Stocks", "Energy Stocks","global market",
 "Investment Strategy", "banking","Stock markets","stocks","revenue","profit/loss","trading",'stock', 'market', 'shares', 'earnings', 'revenue', 'profit', 'losses',
    ...
    for subreddit_name in subreddit_list:
        try:
            ...
            for post in subreddit.hot(limit=100):
                ...
                if post.score >= 150 and any(keyword.lower() in post.title.lower() for keyword in financial_keywords):
                    post_data = {
                        'score': post.score,
...
@app.post("/web-headlines/", response_model=List[HeadlineAnalysis])
async def analyze_web_headlines(urls: UrlInput):
    ...
    finance_keywords = [
"Interest Rates", "Federal Reserve", "Economic Indicators", "Bitcoin","cryptocurrency"
"Inflation", "Stock Buybacks", "Market Correction", "Business", "Bullish",
"stock analysis", "GDP", "Recession", "Financial Stability", "SEC Regulations",
"Debt Ceiling", "business", "Tech Stocks", "Energy Stocks","global market","technical news",
 "Investment Strategy", "Trading","Stock markets","stocks","revenue","profit/loss","stocks",'stock', 'market', 'shares', 'earnings', 'revenue', 'profit', 'losses',
            'investment', 'investors'
    ]
...
@app.post("/news-headlines/", response_model=List[HeadlineAnalysis])
